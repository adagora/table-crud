    ...
    return (
      <Grid item>
        {page.disabled ? (
          ...
          <Typography onClick={() => setNavbarOpen(false)}>
            <Link
              href={page.link}
              sx={{
    ...
    <>
      <AppBar
        ...
        sx={{
          ...
          background: `${trigger ? theme.palette.background : ''}`,
        }}
      >
        <Container>
          <Grid container justifyContent="space-between" alignItems="center" sx={{ minHeight: '70px' }}>
            <Grid
              item
              alignItems="center"
              sx={{
