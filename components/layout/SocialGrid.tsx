...
const SocialGrid: FC<Props> = props => {
  ...
  return (
    <>
      {telegram && (
        <Grid item>
          <Link href={telegram} target="_blank" sx={iconLinkStyles} rel="noreferrer">
      ...
      {discord && (
        <Grid item>
          <Link href={discord} target="_blank" sx={iconLinkStyles} rel="noreferrer">
      ...
      {twitter && (
        <Grid item>
          <Link href={twitter} target="_blank" sx={iconLinkStyles} rel="noreferrer">
      ...
      {youtube && (
        <Grid item>
          <Link href={youtube} target="_blank" sx={iconLinkStyles} rel="noreferrer">
      ...
      {medium && (
        <Grid item>
          <Link href={medium} target="_blank" sx={iconLinkStyles} rel="noreferrer">
      ...
      {linkedin && (
        <Grid item>
          <Link href={linkedin} target="_blank" sx={iconLinkStyles} rel="noreferrer">
      ...
      {reddit && (
        <Grid item>
          <Link href={reddit} target="_blank" sx={iconLinkStyles} rel="noreferrer">
